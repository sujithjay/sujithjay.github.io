...
description: Papers and resources I have found essential to understanding and building data-intensive systems
author: Sujith Jay Nair
permalink: /reading-list/data-systems
---
A list of papers, articles, and online resources I have found essential to understanding data-intensive systems and building new data systems. The list is curated and maintained by Sujith Jay Nair ([@sujithjay](https://github.com/sujithjay/)). If you think a paper should be part of this list, please submit a pull request [here](https://github.com/sujithjay/data-readings). I will add it to the list once I read the paper. Please make sure the subject-matter of the paper is within the realm of either i) understanding data systems, or ii) building data systems.

Data systems are defined to include:
- Database systems
- Data processing systems

This list is inspired by Reynold Xin's list on [Database Readings](https://github.com/rxin/db-readings), and is a work in progress. Where I have written about a paper on this blog, its entry links to my notes.
